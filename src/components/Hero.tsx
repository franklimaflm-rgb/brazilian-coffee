        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 tablet:gap-4 portrait:gap-3 justify-center mb-12 tablet:mb-10 portrait:mb-6">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="bg-white/90 border-white/50 text-primary hover:bg-white hover:text-primary px-8 py-4 tablet:py-3.5 portrait:py-3 text-lg font-semibold transition-all duration-300 hover:scale-105"
              onClick={() => navigate('/menu')}
            >
