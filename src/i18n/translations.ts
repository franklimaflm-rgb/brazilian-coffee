  ...
  "pt-BR": {
    ...
    delivery: {
      ...
      orderForm: {
        ...
        selectCoffee: "Selecione seu Café",
        quantity: "Quantidade",
        specialInstructions: "Instruções Especiais",
        specialInstructionsPlaceholder: "Alguma observação especial para seu pedido...",
      ...
      validation: {
        ...
        addressTooFar: "Endereço fora da área de entrega (máximo 5km)",
        addressInvalid: "Endereço não encontrado",
        withinRange: "Endereço dentro da área de entrega!",
        nameRequired: "Nome é obrigatório",
        emailRequired: "E-mail é obrigatório",
        emailInvalid: "E-mail inválido",
        phoneRequired: "Telefone é obrigatório",
        coffeeRequired: "Selecione um café",
        quantityRequired: "Quantidade deve ser pelo menos 1"
      },
      map: {
        title: "Área de Entrega",
        description: "Área de cobertura do nosso delivery",
        yourLocation: "Sua Localização",
        deliveryCenter: "Centro de Distribuição",
        deliveryRadius: "Raio de Entrega (5km)"
      }
    },
  ...
  "en-GB": {
    ...
    delivery: {
      ...
      validation: {
        ...
        addressTooFar: "Address outside delivery area (maximum 5km)",
        addressInvalid: "Address not found",
        withinRange: "Address within delivery area!",
        nameRequired: "Name is required",
        emailRequired: "Email is required",
        emailInvalid: "Invalid email",
        phoneRequired: "Phone is required",
        coffeeRequired: "Please select a coffee",
        quantityRequired: "Quantity must be at least 1"
      },
      map: {
        title: "Delivery Area",
        description: "Our delivery coverage area",
        yourLocation: "Your Location",
        deliveryCenter: "Distribution Centre",
        deliveryRadius: "Delivery Radius (5km)"
      }
    },
